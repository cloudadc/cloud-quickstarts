...
<br>F5 Demo App
    ...
    Server Port: 8080
    Server Hostname: backend-v1-677c668965-vlq9t

    Client IP: 35.191.15.169
    Client Port: 59488
    Client Hostname: 35.191.15.169

    Session: 7E1EEB086247D8CF7006B0467991B1EC

    X-Forwarded-For: 42.61.112.56, 35.190.122.65

    Cookies:  

    Request Headers: x-forwarded-proto: [http] x-cloud-trace-context: [c1e23ac203b90a5d86988cdd3fdbaed3/7968553811219848501] host: [35.190.122.65] connection: [Keep-Alive] x-forwarded-for: [42.61.112.56, 35.190.122.65] user-agent: [curl/7.64.1] accept: [*/*] via: [1.1 google] 

$ curl 35.190.122.65/bar
<br>F5 Demo App
    ...
    Client IP: 35.191.8.32
    Client Port: 53413
    Client Hostname: 35.191.8.32

    Session: E7A29B4FBDD839B568C6359EA4424B46

    X-Forwarded-For: 42.61.112.56, 35.190.122.65

    Cookies:  

    Request Headers: x-forwarded-proto: [http] x-cloud-trace-context: [d13bec3b9a466d4e95860683ee9c8c7b/3747056814182796428] host: [35.190.122.65] connection: [Keep-Alive] x-forwarded-for: [42.61.112.56, 35.190.122.65] user-agent: [curl/7.64.1] accept: [*/*] via: [1.1 google] 
----

*5. View the backend service*
...
[
  {
    ...
    "backends": [
      {
        "balancingMode": "RATE",
        "capacityScaler": 1,
        "group": "https://www.googleapis.com/compute/v1/projects/playground-s-11-17534dca/zones/us-central1-a/instanceGroups/k8s-ig--cd972525ecc36141",
    ...
    "creationTimestamp": "2023-04-24T17:37:31.994-07:00",
    ...
    "enableCDN": false,
    "fingerprint": "q38YQxhGMAQ=",
    "healthChecks": [
      "https://www.googleapis.com/compute/v1/projects/playground-s-11-17534dca/global/healthChecks/k8s-be-32075--cd972525ecc36141"
    ],
    "id": "6509424970637680164",
    ...
    "name": "k8s-be-32075--cd972525ecc36141",
    "port": 32075,
    "portName": "port32075",
    "protocol": "HTTP",
    "selfLink": "https://www.googleapis.com/compute/v1/projects/playground-s-11-17534dca/global/backendServices/k8s-be-32075--cd972525ecc36141",
    "sessionAffinity": "NONE",
    "timeoutSec": 30
  },
  {
    ...
    "backends": [
      {
        "balancingMode": "RATE",
        "capacityScaler": 1,
        "group": "https://www.googleapis.com/compute/v1/projects/playground-s-11-17534dca/zones/us-central1-a/networkEndpointGroups/k8s1-cd972525-backend-backend-lb-svc-80-f7f7db8f",
    ...
    "creationTimestamp": "2023-04-24T17:38:20.432-07:00",
    "description": "{\"kubernetes.io/service-name\":\"backend/backend-lb-svc\",\"kubernetes.io/service-port\":\"\\u0026ServiceBackendPort{Name:,Number:80,}\",\"x-features\":[\"NEG\"]}",
    "enableCDN": false,
    "fingerprint": "i9rtl_Rootw=",
    "healthChecks": [
      "https://www.googleapis.com/compute/v1/projects/playground-s-11-17534dca/global/healthChecks/k8s1-cd972525-backend-backend-lb-svc-80-f7f7db8f"
    ],
    "id": "3310239372425207315",
    "kind": "compute#backendService",
    "loadBalancingScheme": "EXTERNAL",
    "logConfig": {
      "enable": true,
    ...
    "name": "k8s1-cd972525-backend-backend-lb-svc-80-f7f7db8f",
    "port": 30250,
    "portName": "port30250",
    "protocol": "HTTP",
    "selfLink": "https://www.googleapis.com/compute/v1/projects/playground-s-11-17534dca/global/backendServices/k8s1-cd972525-backend-backend-lb-svc-80-f7f7db8f",
    "sessionAffinity": "NONE",
    "timeoutSec": 30
  },
  {
    ...
    "backends": [
      {
        "balancingMode": "RATE",
        "capacityScaler": 1,
        "group": "https://www.googleapis.com/compute/v1/projects/playground-s-11-17534dca/zones/us-central1-a/networkEndpointGroups/k8s1-cd972525-backend-backend-svc-80-e4b71c05",
        "maxRatePerEndpoint": 1
      }
    ],
    "connectionDraining": {
    ...
    "creationTimestamp": "2023-04-24T17:37:58.480-07:00",
    "description": "{\"kubernetes.io/service-name\":\"backend/backend-svc\",\"kubernetes.io/service-port\":\"\\u0026ServiceBackendPort{Name:,Number:80,}\",\"x-features\":[\"NEG\"]}",
    "enableCDN": false,
    "fingerprint": "okTZLRm5-Wc=",
    "healthChecks": [
      "https://www.googleapis.com/compute/v1/projects/playground-s-11-17534dca/global/healthChecks/k8s1-cd972525-backend-backend-svc-80-e4b71c05"
    ],
    "id": "3904536763131665929",
    "kind": "compute#backendService",
    "loadBalancingScheme": "EXTERNAL",
    "logConfig": {
      "enable": true,
    ...
    "name": "k8s1-cd972525-backend-backend-svc-80-e4b71c05",
    "port": 30100,
    "portName": "port30100",
    "protocol": "HTTP",
    "selfLink": "https://www.googleapis.com/compute/v1/projects/playground-s-11-17534dca/global/backendServices/k8s1-cd972525-backend-backend-svc-80-e4b71c05",
    "sessionAffinity": "NONE",
    "timeoutSec": 30
  }
]
...
[
  {
    "creationTimestamp": "2023-04-24T17:39:46.886-07:00",
    "defaultService": "https://www.googleapis.com/compute/v1/projects/playground-s-11-17534dca/global/backendServices/k8s-be-32075--cd972525ecc36141",
    "fingerprint": "DcVbT4gKuY0=",
    "hostRules": [
      {
        "hosts": [
          "*"
    ...
    "id": "299235090522349501",
    "kind": "compute#urlMap",
    "name": "k8s2-um-3vjgmzch-backend-backend-ingress-hwivzqsl",
    "pathMatchers": [
      {
        "defaultService": "https://www.googleapis.com/compute/v1/projects/playground-s-11-17534dca/global/backendServices/k8s-be-32075--cd972525ecc36141",
        ...
        "pathRules": [
          {
            ...
            "service": "https://www.googleapis.com/compute/v1/projects/playground-s-11-17534dca/global/backendServices/k8s1-cd972525-backend-backend-svc-80-e4b71c05"
          },
          {
            "paths": [
              "/bar"
            ],
            "service": "https://www.googleapis.com/compute/v1/projects/playground-s-11-17534dca/global/backendServices/k8s1-cd972525-backend-backend-lb-svc-80-f7f7db8f"
          }
        ]
      }
    ],
    "selfLink": "https://www.googleapis.com/compute/v1/projects/playground-s-11-17534dca/global/urlMaps/k8s2-um-3vjgmzch-backend-backend-ingress-hwivzqsl"
  }
]
----
