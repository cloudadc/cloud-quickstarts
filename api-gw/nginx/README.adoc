...
.*3. Create cluster*
----
gcloud container clusters create $my_cluster --num-nodes=2 --zone=$my_zone --cluster-version=1.24.12-gke.1000 --enable-ip-alias
----
...
image:501/nginx-cookie-arch-a.png[Image,400,140]
...
image:501/nginx-cookie-arch-b.png[Image,400,178]
